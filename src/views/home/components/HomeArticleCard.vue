<template>
  <div>
    <v-card v-for="articleItem of article.list" :key="articleItem._id" class="art-card">
      <!-- 图片  -->
      <div class="art-cover">
